...
describe('useCopyToClipboard', () => {
  ...
  it('should use custom copy function', async () => {
    const copyFnMock = jest.fn().mockResolvedValue(true)
  ...
  it('should handle cut failure', async () => {
    const writeTextMock = jest.fn().mockRejectedValue(new Error('Cut failed'))
    Object.assign(navigator, {
      clipboard: {
        writeText: writeTextMock,
      },
  ...
  it('should paste text from clipboard', async () => {
    const readTextMock = jest.fn().mockResolvedValue('Hello, World!')
    Object.assign(navigator, {
      clipboard: {
  ...
  it('should handle paste failure', async () => {
    const readTextMock = jest.fn().mockRejectedValue(new Error('Paste failed'))
    Object.assign(navigator, {
      clipboard: {
        readText: readTextMock,
      },
