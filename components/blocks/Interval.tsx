  ...
  return (
    ...
    <TooltipProvider>
      <Tooltip>
        ...
        <TooltipContent side='bottom' className='max-w-[50ch] text-justify'>
<p>In this case, the count counter is incremented by 1 every second (1000 milliseconds) with useInterval. When the count value reaches 25, it is reset back to 0.</p>
        </TooltipContent>
      </Tooltip>
    </TooltipProvider>
        </div>
