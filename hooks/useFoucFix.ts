...
interface UseFoucFixOptions {
  onMutation?: (mutations: MutationRecord[]) => void
  observedAttributes?: string[]
}

export function useFoucFix(options: UseFoucFixOptions = {}): void {
  const { onMutation, observedAttributes = ['media'] } = options
